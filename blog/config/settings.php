<?php
$baseURL = '/srv/httpd/starside.de/www/job/blog'; // set the file where the blog will be installed - no trailing '/'. DOCUMENT_ROOT is a path to your server's root. (eg. /var/www/html/)
...
$websiteRoot = 'http://starside.de/job/blog'; //root of your blog (eg. http://www.yoursite.com/blog)
...
$rssLink = 'http://starside.de/job/blog/index.php';//set the link to your site
